...
with open("input2.txt") as input_file:
    with open("qmpi_macro_output.txt", "w") as qmpi_macro_output:
        with open("trait_functions2_output.txt", "w") as trait_functions_output:
            with open("pmpi_macro_output.txt", "w") as pmpi_macro_output:
                while True:
                    try:
