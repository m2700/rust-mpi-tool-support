...
where
    F: FnOnce(*mut c_void, c_int, MPI_Datatype, c_int, c_int, MPI_Comm, *mut MPI_Request) -> c_int,
{
...
#[inline]
fn type_lb<F>(next_f: UnsafeBox<F>, datatype: MPI_Datatype, displacement: *mut MPI_Aint) -> c_int
where
    F: FnOnce(MPI_Datatype, *mut MPI_Aint) -> c_int,
{
...
#[inline]
fn type_ub<F>(next_f: UnsafeBox<F>, datatype: MPI_Datatype, displacement: *mut MPI_Aint) -> c_int
where
    F: FnOnce(MPI_Datatype, *mut MPI_Aint) -> c_int,
{
    unsafe { next_f.unwrap()(datatype, displacement) }
...
where
    F: FnOnce(*const c_void, *mut c_void, *const c_int, MPI_Datatype, MPI_Op, MPI_Comm) -> c_int,
{
...
#[inline]
fn get_processor_name<F>(next_f: UnsafeBox<F>, name: *mut c_char, resultlen: *mut c_int) -> c_int
where
...
#[inline]
fn errhandler_get<F>(next_f: UnsafeBox<F>, comm: MPI_Comm, errhandler: *mut MPI_Errhandler) -> c_int
where
...
where
    F: FnOnce(*const c_void, *mut c_void, MPI_Datatype, c_int, MPI_Aint, MPI_Op, MPI_Win) -> c_int,
{
    unsafe {
        next_f.unwrap()(
            origin_addr,
...
#[inline]
fn type_delete_attr<F>(next_f: UnsafeBox<F>, datatype: MPI_Datatype, type_keyval: c_int) -> c_int
where
...
#[inline]
fn type_set_name<F>(next_f: UnsafeBox<F>, datatype: MPI_Datatype, type_name: *const c_char) -> c_int
where
...
#[inline]
fn alloc_mem<F>(next_f: UnsafeBox<F>, size: MPI_Aint, info: MPI_Info, baseptr: *mut c_void) -> c_int
where
...
#[inline]
fn comm_set_errhandler<F>(next_f: UnsafeBox<F>, comm: MPI_Comm, errhandler: MPI_Errhandler) -> c_int
where
    F: FnOnce(MPI_Comm, MPI_Errhandler) -> c_int,
{
    unsafe { next_f.unwrap()(comm, errhandler) }
...
#[inline]
fn file_set_errhandler<F>(next_f: UnsafeBox<F>, file: MPI_File, errhandler: MPI_Errhandler) -> c_int
where
...
#[inline]
fn get_address<F>(next_f: UnsafeBox<F>, location: *const c_void, address: *mut MPI_Aint) -> c_int
where
...
#[inline]
fn win_set_errhandler<F>(next_f: UnsafeBox<F>, win: MPI_Win, errhandler: MPI_Errhandler) -> c_int
where
...
where
    F: FnOnce(MPI_File, MPI_Offset, MPI_Datatype, MPI_Datatype, *const c_char, MPI_Info) -> c_int,
{
...
where
    F: FnOnce(MPI_File, MPI_Offset, *const c_void, c_int, MPI_Datatype, *mut MPI_Status) -> c_int,
{
    unsafe { next_f.unwrap()(fh, offset, buf, count, datatype, status) }
}
#[inline]
...
where
    F: FnOnce(MPI_File, MPI_Offset, *mut c_void, c_int, MPI_Datatype, *mut MPI_Request) -> c_int,
{
...
where
    F: FnOnce(MPI_File, MPI_Offset, *const c_void, c_int, MPI_Datatype, *mut MPI_Request) -> c_int,
{
    unsafe { next_f.unwrap()(fh, offset, buf, count, datatype, request) }
}
#[inline]
...
#[inline]
fn file_get_position_shared<F>(next_f: UnsafeBox<F>, fh: MPI_File, offset: *mut MPI_Offset) -> c_int
where
    F: FnOnce(MPI_File, *mut MPI_Offset) -> c_int,
{
    unsafe { next_f.unwrap()(fh, offset) }
