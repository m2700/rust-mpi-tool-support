                ...
                for line in input_file.readlines():
                    ...
                    if line.startswith("fn ") and line.endswith(";"):
                        ...
                        type_convert_output_file.write(
                            "fn " + fn_ident +
                            "[" + patterns.macro_mpi_func_id_prefix +
                            fn_ident[2:] + ", "
                            + intercept_ident
                            + "](" + ", ".join(macro_arg_line) + ") -> "
                            + macro_rust_res_tp + ";\n"
